 ...
 */
export declare function getProfileSchema(profile: EdmProfile): import("zod").ZodObject<{
    core: import("zod").ZodObject<{
        anchor: import("zod").ZodNullable<import("zod").ZodString>;
        spark: import("zod").ZodNullable<import("zod").ZodString>;
        wound: import("zod").ZodNullable<import("zod").ZodString>;
        fuel: import("zod").ZodNullable<import("zod").ZodString>;
        bridge: import("zod").ZodNullable<import("zod").ZodString>;
        echo: import("zod").ZodNullable<import("zod").ZodString>;
    ...
    constellation: import("zod").ZodObject<{
        emotion_primary: import("zod").ZodNullable<import("zod").ZodUnion<[import("zod").ZodEnum<["joy", "sadness", "fear", "anger", "wonder", "peace", "tenderness", "reverence", "pride", "anxiety", "gratitude", "longing", "hope", "shame", "disappointment", "relief", "frustration"]>, import("zod").ZodString]>>;
        emotion_subtone: import("zod").ZodArray<import("zod").ZodString, "many">;
        narrative_arc: import("zod").ZodNullable<import("zod").ZodUnion<[import("zod").ZodEnum<["overcoming", "transformation", "connection", "reflection", "closure", "loss", "confrontation"]>, import("zod").ZodString]>>;
    }, "strip", import("zod").ZodTypeAny, {
        emotion_primary: string | null;
        emotion_subtone: string[];
        narrative_arc: string | null;
    ...
    experiential_stance: import("zod").ZodOptional<import("zod").ZodNullable<import("zod").ZodEnum<["lived", "witnessed", "quoted_third_party", "assistant_generated", "hypothetical"]>>>;
}, "strip", import("zod").ZodTypeAny, {
    core: {
        anchor: string | null;
        spark: string | null;

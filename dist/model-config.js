 ...
 */
const DEFAULT_EXTRACTION_PROVIDER = "anthropic";
 ...
 */
export function resolveExtractionProvider(requested) {
 ...
 */
function usingOpenRouterForKimi() {
 ...
 */
export function fallbackModel(provider) {
 ...
 */
export function resolveExtractionModel(provider, requested) {
    return (requested ??
 ...
 */
export function resolveStanceModel(provider, requested) {
 ...
 */
export function stanceRequestExtensions(provider, model) {
